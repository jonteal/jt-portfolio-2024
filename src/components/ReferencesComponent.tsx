export const ReferencesComponent = () => (
  <div className="resume-body-container border w-screen rounded-xl flex flex-col items-center bg-gray-800 pt-7">
    ...
    <div className="summary-section mb-3 mt-5 flex items-center">
      <h3 className="text-gray-100 text-2xl font-bold">Francis Vithayathil</h3>
      <p className="text-gray-100 text-1xl">
    ...
    <div className="summary-section mb-3 mt-5 flex items-center">
      ...
      <p className="text-gray-100 text-1xl">Digital Development Engineer III</p>
      <p className="text-gray-100 text-1xl">CVS Health / Aetna</p>
      <a href="mailto: hollandm2@aetna.com" className="text-gray-100 text-1xl">
        hollandm2@aetna.com
      </a>
    ...
    <div className="summary-section mb-3 mt-5 flex items-center">
      ...
      <p className="text-gray-100 text-1xl">CVS Health / Aetna</p>
      <a href="mailto: ontiverosi@aetna.com" className="text-gray-100 text-1xl">
    ...
    <div className="summary-section mb-3 mt-5 flex items-center">
      ...
      <a href="mailto: rmpcoding@gmail.com" className="text-gray-100 text-1xl">
        rmpcoding@gmail.com
      </a>
